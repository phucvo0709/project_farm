<div class="container">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="contact_name" maxlength="100" value="{$contact_name}">    
    </div>
    <div class="form-group">
        <label for="position">Position:</label>
        <input type="text" class="form-control" name="position" maxlength="100" value="{$position}">    
    </div>
    <div class="form-group">
