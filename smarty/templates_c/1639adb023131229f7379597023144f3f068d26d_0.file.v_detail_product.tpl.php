<?php
/* Smarty version 3.1.30, created on 2017-12-20 02:22:11
  from "C:\wamp64\www\farm\views\v_detail_product.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a39c953838132_03767783',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1639adb023131229f7379597023144f3f068d26d' => 
    array (
      0 => 'C:\\wamp64\\www\\farm\\views\\v_detail_product.tpl',
      1 => 1513736530,
      2 => 'file',
    ),
  ),
...
function content_5a39c953838132_03767783 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="global indent">
    ...
    <div class="container">
        <div class="row">
            <article class="col-lg-9 col-md-9 col-sm-9 deliveringBox">
                            ...
                            <div class="col-lg-8">
                                <div class="title_product">
                                    <h1 class="w3-text-orange">
                                        <b>$ <?php echo number_format($_smarty_tpl->tpl_vars['product']->value->price);?>
</b>
                                    </h1>  
                                </div>
                                <div class="description_product w3-margin-top w3-margin-bottom">
                                    <div class="w3-card-4">
                                        ...
                                        <h1><?php echo $_smarty_tpl->tpl_vars['t_d']->value;?>
</h1>
                                        </header>
...
?>  
                                        <h3><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:<?php echo $_smarty_tpl->tpl_vars['ct']->value->phone_number;?>
"><?php echo $_smarty_tpl->tpl_vars['ct']->value->phone_number;?>
</a></h3>
                                        <h3><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $_smarty_tpl->tpl_vars['ct']->value->email;?>
</h3>
                                        <?php
}
}
...
?>
                    <li><a href="<?php echo thu_vien::Bo_dau($_smarty_tpl->tpl_vars['product']->value->title);?>
...
">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="phone_number" name="phone_number" value="" maxlength="20" required>
                    </div>
                    <div class="form-group">
